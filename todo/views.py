...
def add_item(request):
    ...
    if request.method == 'POST':
        ...
        done = 'done' in request.POST  # Getting the items boolean value of the checkbox
        Item.objects.create(name=name, done=done)  # Passing the items variables to the create object method. To create it on the database
        
        return redirect('get_todo_list')  # Using the redirect method it redirects the user to the 'home'/previous page. - Remembering redirect needs importing
